...
/**
 * The Class LoadContextElement.
 */
public class LoadContextElement extends ContextElement{
	...
	/**
	 * Instantiates a new load context element.
	 *
	 * @param load the load
	 */
	public LoadContextElement(Load load){
