...
/**
 * The Class MeterContextElementForTest.
 */
public class MeterContextElementForTest extends ContextElement{
	
	/** The Constant METER_TYPE. */
	private static final String METER_TYPE = "MeterTest";
	...
	/**
	 * Instantiates a new meter context element for test.
	 *
	 * @param meter the meter
	 */
	public MeterContextElementForTest(Meter meter){
